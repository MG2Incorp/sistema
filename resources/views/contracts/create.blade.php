            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ action('ContractController@store') }}" method="POST" id="form_contract">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" class="form-control summernote editor" rows="5" style="resize: none"></textarea>
                                    </div>
