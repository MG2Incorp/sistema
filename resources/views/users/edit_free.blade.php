        ...
        <div class="row">
            <div class="col-12">
                <div class="card box border-warning">
                    ...
                    <div class="card-body">
                        <form action="{{ action('UserController@update_free', $user->id) }}" method="POST" id="form_user">
                            {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="constructor" class="form-control">
                                                @foreach($constructors as $constructor)
                                                    <option value="{{ $constructor->id }}" {{ $constructor->id == $user->constructor_id ? 'selected' : '' }}>{{ $constructor->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            @foreach($user->projects as $project)
                                @if($user->user_projects->where('project_id', $project->id)->first()->company_id == 0)
