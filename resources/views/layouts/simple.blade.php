...
<body>
            ...
            <div class="u-header__section">
                <div id="logoAndNav" class="container">
                    ...
                    <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space py-2">
                        <a class="navbar-brand u-header__navbar-brand-center" href="{{ route('index') }}">
                            <img src="{{ asset('img/logo2.png') }}"></a>
    ...
    <script>
        $(window).on('load', function() {
            ...
            $(document).on('click', '#goto_sobre', function() {
                $('html,body').animate({
                    scrollTop: $('#sobre').offset().top - 70
                }, 1000);
            });
            $(document).on('click', '#goto_cases', function() {
                $('html,body').animate({
                    scrollTop: $('#cases').offset().top - 70
                }, 1000);
            });
            $(document).on('click', '#goto_modulos', function() {
                $('html,body').animate({
                    scrollTop: $('#modulos').offset().top - 70
                }, 1000);
            });
            $(document).on('click', '#goto_contratacao', function() {
                $('html,body').animate({
                    scrollTop: $('#contratacao').offset().top - 70
                }, 1000);
            });
        });
